    ...
    <View className="flex-1">
      <ImageBackground source={GettingStarted} className="w-full h-full ">
        <View className="absolute w-full bottom-14 justify-center items-center">
          <Text className=" text-2xl font-semibold z-10 text-gray-300 ">
            theruvu taste
          </Text>
          <Text className=" text-4xl font-semibold z-10 text-black/95 ">
            Hidden Gem Spot
          </Text>
          <Text className=" text-3xl font-semibold z-10 text-orange-500 ">
            Nearest to you
          </Text>
          <GetStartedModel/>
